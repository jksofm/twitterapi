...
import { RegisterRequestBody } from '~/models/interface/requests/Users.requests'
...
const PASSWORD = 'Elegant501998!'
// ID của tài khoản của mình, dùng để follow người khác
const MYID = new ObjectId('64ba2615b8d626c0589e0e8b')
